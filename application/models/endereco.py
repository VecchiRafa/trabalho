...
from sqlalchemy import DATETIME,INT, VARCHAR, ForeignKey, CHAR, SMALLINT
from sqlalchemy.orm import Mapped, mapped_column
from sqlalchemy.dialects.mysql import INT, SMALLINT
from datetime import datetime

class Endereco(Base):
    __tablename__ = "endereco"

    id_endereco: Mapped[int] = mapped_column("id_endereco", INT,nullable=False, primary_key=True, autoincrement=True)
    ...
    id_pessoa: Mapped[int] = mapped_column("id_pessoa", INT, ForeignKey(Pessoa.id_pessoa), primary_key=True, nullable=False)
