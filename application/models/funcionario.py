...
from sqlalchemy import INT, FLOAT, DECIMAL, ForeignKey, DATETIME, VARCHAR
...
class Funcionario(Base):
    ...
    id_funcionario: Mapped[int] = mapped_column("id_cliente", INT, ForeignKey(Pessoa.id_pessoa), primary_key=True, nullable=False, autoincrement=True)
