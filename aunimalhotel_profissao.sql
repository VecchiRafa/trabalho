...
CREATE TABLE `profissao` (
  `id_profissao` int unsigned NOT NULL AUTO_INCREMENT,
  `profissao` varchar(45) NOT NULL,
  `descricao` tinytext,
  PRIMARY KEY (`id_profissao`),
  UNIQUE KEY `id_profissao_UNIQUE` (`id_profissao`),
  UNIQUE KEY `profissao_UNIQUE` (`profissao`)
...
INSERT INTO `profissao` VALUES (1,'amar','aa');
