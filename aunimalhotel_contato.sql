...
CREATE TABLE `contato` (
  ...
  UNIQUE KEY `numero_UNIQUE` (`numero`) /*!80000 INVISIBLE */,
  UNIQUE KEY `id_associado_UNIQUE` (`id_associado`),
  KEY `fk_associado_idx` (`id_associado`),
  CONSTRAINT `fk_id_associado` FOREIGN KEY (`id_associado`) REFERENCES `associado` (`id_associado`) ON DELETE RESTRICT
