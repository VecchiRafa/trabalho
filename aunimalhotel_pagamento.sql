...
CREATE TABLE `pagamento` (
  ...
  KEY `fk_pagamento_funcionario_idx` (`id_funcionario`),
  CONSTRAINT `fk_pagamento_funcionario` FOREIGN KEY (`id_funcionario`) REFERENCES `funcionario` (`id_funcionario`) ON DELETE RESTRICT
